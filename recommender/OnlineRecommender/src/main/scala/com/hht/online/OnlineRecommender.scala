...
object ConnHelper extends Serializable{
  // 懒变量定义，使用的时候才初始化
  lazy val jedis = new Jedis("47.107.32.131")
  lazy val mongoClient = MongoClient(MongoClientURI("mongodb://8.129.42.178:27017/recommender"))
}
...
object OnlineRecommender {
  ...
  def main(args: Array[String]): Unit = {
    ...
    // 创建kafka配置参数
    val kafkaParam = Map(
      "bootstrap.servers" -> "47.107.32.131:9092",
